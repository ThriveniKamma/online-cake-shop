...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 31, 2022 at 10:47 AM
...
(1, 'Eggless', 'Eggless', NULL, 'eggless.jpg'),
(2, 'Kids Cake', 'Kids Cake', NULL, 'kidscake.jpg'),
(3, 'Photo Cake', 'Photo Cake', NULL, 'photocake.jpg'),
(4, 'Premium Cake', 'Premium Cake', NULL, 'premiumcake.jpg'),
(5, 'Cup Cakes', 'Cup Cakes', NULL, 'cupcake.jpg'),
(6, 'Dry Cakes', 'Dry Cakes', NULL, 'drycakes.jpg');
...
(1, 'Fruits Cake', '1', 'pineapplejellyfruitcake.jpg', 'A cake is a sweet food made by baking a mixture of flour, eggs, sugar, and fat in an oven. Cakes may be large and cut into slices or small and intended for one person only. ... Food that is formed into flat round shapes before it is cooked can be referred to as cakes.\n', NULL, '1000', NULL),
(4, 'Chocolate Cake', '5', 'chocolatecake.jpg', 'A cake is a sweet food made by baking a mixture of flour, eggs, sugar, and fat in an oven. Cakes may be large and cut into slices or small and intended for one person only. ... Food that is formed into flat round shapes before it is cooked can be referred to as cakes.\n', NULL, '900', NULL),
(5, 'Black Forest Cake', '3', 'blackforestcake.jpg', 'A cake is a sweet food made by baking a mixture of flour, eggs, sugar, and fat in an oven. Cakes may be large and cut into slices or small and intended for one person only. ... Food that is formed into flat round shapes before it is cooked can be referred to as cakes.\n', NULL, '800', NULL),
(6, 'Butterscotch Cake', '5', 'butterscotchcake.jpg', 'A cake is a sweet food made by baking a mixture of flour, eggs, sugar, and fat in an oven. Cakes may be large and cut into slices or small and intended for one person only. ... Food that is formed into flat round shapes before it is cooked can be referred to as cakes.\n', NULL, '600', NULL),
(7, 'Vanilla Cake', '1', 'vanilla.jpg', 'A cake is a sweet food made by baking a mixture of flour, eggs, sugar, and fat in an oven. Cakes may be large and cut into slices or small and intended for one person only. ... Food that is formed into flat round shapes before it is cooked can be referred to as cakes.\n', NULL, '1200', NULL),
(9, 'Pineapple Cake', '2', 'pineapplecake.jpg', 'A cake is a sweet food made by baking a mixture of flour, eggs, sugar, and fat in an oven. Cakes may be large and cut into slices or small and intended for one person only. ... Food that is formed into flat round shapes before it is cooked can be referred to as cakes.\n', NULL, '3000', NULL),
(10, 'Red Velvet Cake', '6', 'redvelvetcake.jpg', 'A cake is a sweet food made by baking a mixture of flour, eggs, sugar, and fat in an oven. Cakes may be large and cut into slices or small and intended for one person only. ... Food that is formed into flat round shapes before it is cooked can be referred to as cakes.\n', NULL, '800', NULL),
(11, 'Truffle Cake', '2', 'tufflecake.jpg', 'A cake is a sweet food made by baking a mixture of flour, eggs, sugar, and fat in an oven. Cakes may be large and cut into slices or small and intended for one person only. ... Food that is formed into flat round shapes before it is cooked can be referred to as cakes.\n', NULL, '300', NULL),
(12, 'Blue Berry Cake', '4', 'blueberrycakeindia.jpg', 'A cake is a sweet food made by baking a mixture of flour, eggs, sugar, and fat in an oven. Cakes may be large and cut into slices or small and intended for one person only. ... Food that is formed into flat round shapes before it is cooked can be referred to as cakes.\n', NULL, '400', NULL);
